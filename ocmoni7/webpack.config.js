...
module.exports = {
    ...
    plugins: [
        ...
        ,new HtmlWebpackPlugin({
            ...
            //chunks这个参数告诉插件要引用entry里面的哪几个入口
            chunks: ['datasourceQuery','commonStyle'],
            //要把script插入到标签里
            inject: true
        })
        ,new HtmlWebpackPlugin({
            ...
            //chunks这个参数告诉插件要引用entry里面的哪几个入口
            chunks: ['datasourceEdit','commonStyle'],
            //要把script插入到标签里
            inject: true
        })
        ,new HtmlWebpackPlugin({
            ...
            //chunks这个参数告诉插件要引用entry里面的哪几个入口
            chunks: ['mileageQuery','commonStyle'],
            //要把script插入到标签里
            inject: true
        })
        ,new HtmlWebpackPlugin({
            ...
            //chunks这个参数告诉插件要引用entry里面的哪几个入口
            chunks: ['mileageEdit','commonStyle'],
            //要把script插入到标签里
            inject: true
        })
        ,new HtmlWebpackPlugin({
